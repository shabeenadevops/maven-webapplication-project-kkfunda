...
node
{
   ...
   stage('git checkout')
   {
      git branch: 'master', url: 'https://github.com/shabeenadevops/maven-webapplication-project-kkfunda'
   }
   stage('COMPILE')
   {
   ...
   stage('Deploy to Tomcat') 
    {
      ...
      curl -u kk:password \
--upload-file /var/lib/jenkins/workspace/groovy/target/maven-web-application.war \
